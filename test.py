...
from keras.layers import Dense, Flatten, Lambda, LeakyReLU, Dropout, BatchNormalization, Activation, Concatenate, GlobalAveragePooling2D
...
if __name__ == "__main__":
  ...
  #concat2 = Concatenate()([avg_pool1, avg_pool2])
